...
<div class="p-4 md:p-6 2xl:p-10">
  <div class="mx-auto max-w-md">
    <div class="mb-6 text-center">
      <h2 class="text-title-md2 font-bold text-gray-900 dark:text-white">ลืมรหัสผ่าน</h2>
      <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">กรอกอีเมลที่ใช้สมัคร ระบบจะแจ้งเตือนผู้ดูแลให้ดำเนินการ</p>
    </div>
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
      <form method="post" action="{{ route('password.email') }}" class="space-y-4">
        ...
        <div class="pt-2">
          <button type="submit" class="w-full rounded bg-brand-500 px-4 py-2.5 text-white hover:bg-brand-600">ส่งคำขอรีเซ็ต</button>
        </div>
        <div class="text-center text-sm text-gray-600 dark:text-gray-400">
          จำรหัสผ่านได้แล้ว? <a href="{{ route('login') }}" class="text-brand-600 hover:text-brand-700">เข้าสู่ระบบ</a>
        </div>
      </form>
    </div>
  </div>
