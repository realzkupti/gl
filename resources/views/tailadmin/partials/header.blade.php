            ...
            <div class="ml-auto flex items-center gap-2">
                ...
                @else
                    <button
                        ...
                        class="hidden sm:flex items-center gap-2 rounded-lg border-2 border-orange-500 bg-orange-100 px-3 py-2 text-sm hover:bg-orange-200 dark:border-orange-600 dark:bg-orange-900/20 dark:hover:bg-orange-900/30 transition animate-pulse"
                        title="เลือกบริษัท"
                    >
                        <svg class="w-5 h-5 text-orange-600 dark:text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                        </svg>
                        <span class="font-medium text-orange-800 dark:text-orange-300">กรุณาเลือกบริษัท</span>
                    </button>
                @endif
                @endauth
