                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <a href="{{ route('admin.user-permissions.edit', $user->id) }}"
                               class="inline-flex items-center px-3 py-1.5 bg-brand-600 hover:bg-brand-700 text-white text-sm font-medium rounded-md transition dark:bg-brand-500 dark:hover:bg-brand-600">
